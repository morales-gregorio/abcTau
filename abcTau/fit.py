...
def fit_withABC(MyModel, data_ac , priorDist, inter_save_direc, inter_filename,
                datasave_path, filenameSave, epsilon_0, min_samples, steps,
                minAccRate, parallel=False, n_procs=None, disp=None,
                resume=None, case='general'):
    ...
    abc_results = pmc_abc(model, data, inter_save_direc, inter_filename, epsilon_0=epsilon_0,
                          ...
                          minAccRate=minAccRate, resume=resume, case=case)
